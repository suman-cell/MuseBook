...
try {
    ...
    // Recipients
    $mail->setFrom('your-email@gmail.com', 'MuseBook'); // Replace with your email
    $mail->addAddress($_GET['email'], $name); // Send to the user's email

    // Content
    $mail->isHTML(true);
    $mail->Subject = 'Your Museum Booking Confirmation';
    $mail->Body = "
        ...
        <ul>
            ...
            <li><strong>Total Paid:</strong> ₹" . number_format($total, 2) . "</li>
        </ul>
        <p>Your booking reference: <strong>$booking_reference</strong></p>
        <p>We look forward to your visit!</p>
        <p>Best regards,<br>MuseBook Team</p>
    ";
